...
DaftarSurat daftarSuratFromJson(String str) =>
    DaftarSurat.fromJson(json.decode(str));

String daftarSuratToJson(DaftarSurat data) => json.encode(data.toJson());
...
class DaftarSurat {
  ...
  factory DaftarSurat.fromJson(Map<String, dynamic> json) => DaftarSurat(
        code: json["code"],
